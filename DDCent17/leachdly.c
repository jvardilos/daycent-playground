...
/*          printf("critflow = %12.10f\n", critflow);
      ...
      /* Check for underflow. -mdh
         use numlyrs for index instead of nxt since numlyrs is defined outside loop KLK*/

      if (nitrate[numlyrs] >= 1.0E-10) {
        base_N = nitrate[numlyrs] * basef;
        nitrate[numlyrs] = nitrate[numlyrs] - base_N;
      }
