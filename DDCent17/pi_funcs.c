...
*****************************************************************************/
    ...
    {
    /*
      return(A[1] + (A[2] / (float)M_PI) * (float)atan(M_PI * (double)A[3] * (double)(x - A[0])));
    */
      return(A[1] + A[2] / (float)M_PI * atanf((float)M_PI * A[3] * (x - A[0])));
    }
...
*****************************************************************************/
    float f_logistic(float x, float A[])
    {
      ...
      return(A[0] / (1.0f + A[1] / expf(A[2] * x)));
    }
