...
**             Cindy Keough - 04/2009
**
**             Replaced the numerical approximation to the slope with the
**             derivative.  KLK Dec 2011
**
**  INPUTS:
...
*****************************************************************************/
    ...
    double calc_pet(double rad, double ta, double pa, double dayl)
    {
      ...
      /* slope of the saturation vapor pressure curve at ta 
         using formula from Abbott, P.F., and R.C. Tabony, 1985. 
         The estimation of humidity parameters.  Meteorol. Mag., 114:49-56.
         pvs1 = 610.7 * exp(17.38 * t1 / (239.0 + t1));
         s = (2.53674e6/(239. + ta)/(239. + ta)) * exp((17.38 * ta)/(239. + ta)) */
      s = 239. + ta;
      s = 2536740/(s*s) * exp((17.38 * ta)/s);
