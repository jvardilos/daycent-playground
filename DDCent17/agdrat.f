...
c                       All Rights Reserved
      ...
      real function agdrat (minrlavail,varat,iel)

      implicit none

c ... Argument declarations
      integer    iel
      real       minrlavail(3), varat(3,3)
...
c ... Input:
c ...   minrlavail = mineral E in top soil layer
...
c ... Ratio depends on available E
      ...
      if (minrlavail(iel) .le. 0.0) then

c ..... Set ratio to maximum allowed
        agdrat = varat(1,iel)

      elseif (minrlavail(iel) .gt. varat(3,iel)) then
...
c ..... minrlavail(iel) > 0 and <= varat(3,iel)
        agdrat = (1.-minrlavail(iel)/varat(3,iel))*
