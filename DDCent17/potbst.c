...
**    swpavg  - soil water potential of wettest soil layer within the plant
**              rooting zone (from function "trwtavg")
**
**  GLOBAL VARIABLES:
**    None
**
...
/*        *bstrate = watrate(swpavg, petday, trpar1, 0.10f) *
        ...
        /*New way of calculating the water effect on evapotranspiration.
         Use fraction from trwtavg to replace the call to watrate. CAK - 08/24/2011*/
