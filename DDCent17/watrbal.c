...
**    deltaswc  - change in the soil water, initial minus final, for the day (cm H2O)
**
**  GLOBAL VARIABLES:
**    None
**
                 ...
                 float *snlq2, float *snow, float *runoffdly)
    {
      ...
      /* corrected the snow storage term in the balance equation
         ...
         balance =  ppt - snowstor - sublim + dswc  -intrcpt-evap-transp-outflow
          ...
          =  ppt - (ppt - *melt - sublim - sublim + dswc  -intrcpt-evap-transp-outflow (snow)
      ...
      */
      ...
      balance += (float)*deltaswc - *intrcpt - *evap - *transp - *outflow;
      ...
      fprintf(files->fp_wb,"%7.3f %7.3f %8.5f %7.3f %9.5f ", -(*transp),
              -(*sublim), (float)*deltaswc, -(*outflow), balance);
