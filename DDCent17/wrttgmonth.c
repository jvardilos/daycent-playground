...
**    CH4oxid_month - Methane oxidation for month (gCH4/m^2)
...
#include "soilwater.h"
    ...
    void wrttgmonth(float *time, float *N2O_month, float *NO_month,
                    float *N2_month, float *CH4oxid_month, double *nit_amt_month,
                    float *pptmonth)
    {
      ...
      fprintf(files->fp_tgmonth, "%8.2f  %12.6f  %12.6f  %12.6f  %12.6f",
              *time, *N2O_month, *NO_month, *N2_month, *CH4oxid_month);
