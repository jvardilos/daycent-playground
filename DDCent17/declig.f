...
C ... DECLIG.F
      ...
      subroutine declig(minrlavail,ligcon,lyr,nelem,nlr,ps1co2,rnew,
     &                  rsplig,tcflow,tcstva,csrsnk,cstatv,elstva,
     &                  gromin,minerl,netmnr,resp,som1ci,som1e,som2ci,
     &                  som2e,cflowtosom1,cflowtosom2,newminrl, eins2)
...
c ... Argument declarations
      ...
      real      minrlavail(MAXIEL), ligcon, ps1co2(2), rnew(MAXIEL,2),
     ...
     &          som1e(2,MAXIEL), som2ci(2,ISOS), som2e(2,MAXIEL)
      real      cflowtosom1,cflowtosom2, eins2(2,MAXIEL)
...
c ... Input:
c ...   minrlavail(iel) - iel=1,3 available mineral N, P, S.
...
c ... Local variables
      ...
      real    :: accum(ISOS), co2los, mnrflo, tosom1, tosom2, einflo
...
c ... If Box A can decompose
      ...
      if (candec(nelem,minrlavail,tcstva(llyr),elstva,nlr,
     &           llyr,rnew(:,1))) then
...
c ..... Update mineralization accumulators.
     ...
     &                minerl(1,iel),mnrflo,einflo)
          call mnracc(mnrflo,gromin(iel),netmnr(llyr,iel))
          eins2(actlyr,iel) = eins2(actlyr,iel) + einflo
